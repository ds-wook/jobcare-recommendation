...
class GaussRankScaler(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X: pd.DataFrame, copy: Optional[bool] = None):
    ...
    def _transform(self, i: int, x: pd.DataFrame):
        return erfinv(self.interp_func_[i](x))

    def inverse_transform(self, X: pd.DataFrame, copy: Optional[bool] = None):
    ...
    def _inverse_transform(self, i: int, x: pd.DataFrame) -> float:
